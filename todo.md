...
* одномногострочный elseif (нужен для организации чего-то типа switch-case)
...
* **АНАЛИЗАТОР**: нужен анализатор кода, а для начала анализатор локаций, который:
	* сможет разложить всю игру на локации и проследить все прямые вызовы (или упоминания) и на основе этог построить граф.
	* вести список переменных
- выгрузка всех текстовых констант из игры с **возможностью загрузить обратно!**
- конвертирование базовых действий и описаний в обе стороны!
- 
* ???
