...
4. Имена меток и их значения необходимо писать без пробелов и двоеточий.
...
6. Специальные комментарии `!@` и `!@<` должны быть однострочными! Хотя и могут размещаться в строке с другими операторами.
...
### Сниппеты
Помимо всего прочего теперь вы можете использовать сниппеты.
