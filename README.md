...
*	[Разработка QSP-игр в Sublime Text](#Разработка-QSP-игр-в-Sublime-Text)
	*	[Выбор редактора, или Почему Sublime Text?](#Выбор-редактора-или-Почему-Sublime-Text?)
...
Вообще, на данное время билдер проводит двойную конвертацию utf-8 > cp1251 > (через txt2gam) > utf-16, и при этом теряется часть спецсимволов. Так что будьте аккуратны при работе с билдером. Если пропадают какие-либо спецсимволы из конечной игры, значит на этапе конвертирования в cp1251 их не удалось переконвертировать.
