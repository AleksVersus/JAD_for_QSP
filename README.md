...
Так же обратите внимание, что если в первом "билде" отсутствует перечисление отдельных файлов в элементе "files", то сгенерированная локация-функция будет самой первой локацией в полученном билде! См. раздел ["project"](#project) и раздел ["Порядок сборки и запуска"](#)
