...
class QspSplitter():
	...
	def __init__(self, args={}):
		...
		if 'game-file' in self.args:
			...
			if os.path.isfile(self.qsp_project_file):
				# project file is exist. split the qsps-file
	...
	def split_file(self, game_adr="game.txt",proj_adr="game.qproj",export_fold="export_game"):
		folder_path=""
